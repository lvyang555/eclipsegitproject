...
<script type="text/javascript">
	...
	function update(id) {
		window.location.href = "UpdateStation?id=" + id ;
	}
...
<table align="center" border="1" width="600px" cellspacing="0">
		<tr>
			<th width="200px">车站编号</th>
			<th width="200px">车站名称</th>
			<th width="200px">车站简称</th>
	...
	<center>
		...
		<%
			...
			if (currentPage > 1) {
		%>
		<a href="QueryAllStation.jsp?page=1">第一页</a> <a
			href="QueryAllStation.jsp?page=<%=currentPage - 1%>">上一页</a>
		<%
			}
			if (currentPage < maxPage) {
		%>
		<a href="QueryAllStation.jsp?page=<%=currentPage + 1%>">下一页</a> <a
			href="QueryAllStation.jsp?page=<%=maxPage%>">最后一页&nbsp;</a>
		<%
			}
		%>
	</center>
