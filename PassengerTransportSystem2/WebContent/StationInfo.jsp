...
<table align="center" border="1" width="480px" cellspacing="0">
		...
		List<Station> stations=ss.selectAll();
	...
	<center>
		...
		<%
			...
			if (currentPage > 1) {
		%>
		<a href="StationInfo.jsp?page=1">第一页</a> <a
			href="StationInfo.jsp?page=<%=currentPage - 1%>">上一页</a>
		<%
			}
			if (currentPage < maxPage) {
		%>
		<a href="StationInfo.jsp?page=<%=currentPage + 1%>">下一页</a> <a
			href="StationInfo.jsp?page=<%=maxPage%>">最后一页&nbsp;</a>
		<%
			}
		%>
	</center>
